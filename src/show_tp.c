...
** Last update Sun May 28 18:16:50 2017 Capitaine CASSE
*/

#include "tekadv.h"

static int	draw_tp(t_game *game, t_tp **tp, sfRenderWindow *window)
{
  int		i;
  sfSprite	*sprite;
  sfTexture	*tex;
  ...
  scale = (sfVector2f) {(float)game->tile.x / size.x, (float)game->tile.y / size.y};
